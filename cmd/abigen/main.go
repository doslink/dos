...
import (
	...
	"github.com/doslink/dos/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Doslink contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Doslink contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Doslink contract Solidity source to build and bind")
