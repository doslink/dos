...
// makeWizard creates and returns a new puppdos wizard.
...
// setting up a new or managing an existing Doslink private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppdos, your Doslink private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Doslink network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and dosstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppdos uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Doslink network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppdos", w.network)
