...
import (
	...
	"github.com/doslink/dos/crypto/sha3"
...
// ecrecover extracts the Doslink account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Doslink address
...
// Doslink testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     dosdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Doslink address of the signing key
...
func New(config *params.CliqueConfig, db dosdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Doslink address recovered
