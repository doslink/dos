...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db dosdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db dosdb.Database) error {
