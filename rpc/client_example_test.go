...
//
// dos_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// dos_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.DosSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "dos_getBlockByNumber", "latest"); err != nil {
