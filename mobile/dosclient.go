...
// Contains a wrapper for the Doslink client.
...
import (
	...
	"github.com/doslink/dos/dosclient"
)

// DoslinkClient provides access to the Doslink APIs.
type DoslinkClient struct {
	client *dosclient.Client
}

// NewDoslinkClient connects a client to the given URL.
func NewDoslinkClient(rawurl string) (client *DoslinkClient, _ error) {
	rawClient, err := dosclient.Dial(rawurl)
	return &DoslinkClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *DoslinkClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *DoslinkClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *DoslinkClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *DoslinkClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *DoslinkClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *DoslinkClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *DoslinkClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *DoslinkClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *DoslinkClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *DoslinkClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *DoslinkClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *DoslinkClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *DoslinkClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *DoslinkClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *DoslinkClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *DoslinkClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *DoslinkClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *DoslinkClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *DoslinkClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *DoslinkClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *DoslinkClient) SendTransaction(ctx *Context, tx *Transaction) error {
