...
// Package state provides a caching layer atop the Doslink state trie.
package state
...
// StateDBs within the doslink protocol are used to store anything
...
//
// Carrying over the balance ensures that Doser doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/doslink/dos/pull/16485#issuecomment-380438527),
