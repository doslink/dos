...
// stateObject represents an Doslink account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of doslink address of the account
	data     Account
	db       *StateDB
...
// Account is the Doslink consensus representation of accounts.
