...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb dosdb.Putter) error
}
...
func NewDatabase(db dosdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb dosdb.Putter) error {
