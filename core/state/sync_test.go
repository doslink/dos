...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(dosdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db dosdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db dosdb.Database, root common.Hash) error {
...
func checkStateConsistency(db dosdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, dosdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(dosdb.Database), srcRoot)
