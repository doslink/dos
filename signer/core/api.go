...
import (
	...
	"github.com/doslink/dos/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*dosapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx dosapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*dosapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := dosapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
