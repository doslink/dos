...
const (
	...
	MessageType_MessageType_DoslinkGetAddress       MessageType = 56
	MessageType_MessageType_DoslinkAddress          MessageType = 57
	MessageType_MessageType_DoslinkSignTx           MessageType = 58
	MessageType_MessageType_DoslinkTxRequest        MessageType = 59
	MessageType_MessageType_DoslinkTxAck            MessageType = 60
	...
	MessageType_MessageType_DoslinkSignMessage      MessageType = 64
	MessageType_MessageType_DoslinkVerifyMessage    MessageType = 65
	MessageType_MessageType_DoslinkMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_DoslinkGetAddress",
	57:  "MessageType_DoslinkAddress",
	58:  "MessageType_DoslinkSignTx",
	59:  "MessageType_DoslinkTxRequest",
	60:  "MessageType_DoslinkTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_DoslinkSignMessage",
	65:  "MessageType_DoslinkVerifyMessage",
	66:  "MessageType_DoslinkMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_DoslinkGetAddress":       56,
	"MessageType_DoslinkAddress":          57,
	"MessageType_DoslinkSignTx":           58,
	"MessageType_DoslinkTxRequest":        59,
	"MessageType_DoslinkTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_DoslinkSignMessage":      64,
	"MessageType_DoslinkVerifyMessage":    65,
	"MessageType_DoslinkMessageSignature": 66,
...
// *
// Request: Ask device for Doslink address corresponding to address_n path
// @next PassphraseRequest
// @next DoslinkAddress
// @next Failure
type DoslinkGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DoslinkGetAddress) Reset()                    { *m = DoslinkGetAddress{} }
func (m *DoslinkGetAddress) String() string            { return proto.CompactTextString(m) }
func (*DoslinkGetAddress) ProtoMessage()               {}
func (*DoslinkGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *DoslinkGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DoslinkGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Doslink address derived from device private seed
// @prev DoslinkGetAddress
type DoslinkAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DoslinkAddress) Reset()                    { *m = DoslinkAddress{} }
func (m *DoslinkAddress) String() string            { return proto.CompactTextString(m) }
func (*DoslinkAddress) ProtoMessage()               {}
func (*DoslinkAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *DoslinkAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next DoslinkTxRequest
// @next Failure
type DoslinkSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *DoslinkSignTx) Reset()                    { *m = DoslinkSignTx{} }
func (m *DoslinkSignTx) String() string            { return proto.CompactTextString(m) }
func (*DoslinkSignTx) ProtoMessage()               {}
func (*DoslinkSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *DoslinkSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DoslinkSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *DoslinkSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *DoslinkSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *DoslinkSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *DoslinkSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *DoslinkSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *DoslinkSignTx) GetDataLength() uint32 {
...
func (m *DoslinkSignTx) GetChainId() uint32 {
...
func (m *DoslinkTxRequest) Reset()                    { *m = DoslinkTxRequest{} }
func (m *DoslinkTxRequest) String() string            { return proto.CompactTextString(m) }
func (*DoslinkTxRequest) ProtoMessage()               {}
func (*DoslinkTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *DoslinkTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *DoslinkTxRequest) GetSignatureV() uint32 {
...
func (m *DoslinkTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *DoslinkTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev DoslinkTxRequest
// @next DoslinkTxRequest
type DoslinkTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DoslinkTxAck) Reset()                    { *m = DoslinkTxAck{} }
func (m *DoslinkTxAck) String() string            { return proto.CompactTextString(m) }
func (*DoslinkTxAck) ProtoMessage()               {}
func (*DoslinkTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *DoslinkTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next DoslinkMessageSignature
// @next Failure
type DoslinkSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DoslinkSignMessage) Reset()                    { *m = DoslinkSignMessage{} }
func (m *DoslinkSignMessage) String() string            { return proto.CompactTextString(m) }
func (*DoslinkSignMessage) ProtoMessage()               {}
func (*DoslinkSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *DoslinkSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DoslinkSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type DoslinkVerifyMessage struct {
...
func (m *DoslinkVerifyMessage) Reset()                    { *m = DoslinkVerifyMessage{} }
func (m *DoslinkVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*DoslinkVerifyMessage) ProtoMessage()               {}
func (*DoslinkVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *DoslinkVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DoslinkVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *DoslinkVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev DoslinkSignMessage
type DoslinkMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DoslinkMessageSignature) Reset()                    { *m = DoslinkMessageSignature{} }
func (m *DoslinkMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*DoslinkMessageSignature) ProtoMessage()               {}
func (*DoslinkMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *DoslinkMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DoslinkMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DoslinkGetAddress)(nil), "DoslinkGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*DoslinkAddress)(nil), "DoslinkAddress")
	...
	proto.RegisterType((*DoslinkSignTx)(nil), "DoslinkSignTx")
	proto.RegisterType((*DoslinkTxRequest)(nil), "DoslinkTxRequest")
	proto.RegisterType((*DoslinkTxAck)(nil), "DoslinkTxAck")
	proto.RegisterType((*DoslinkSignMessage)(nil), "DoslinkSignMessage")
	proto.RegisterType((*DoslinkVerifyMessage)(nil), "DoslinkVerifyMessage")
	proto.RegisterType((*DoslinkMessageSignature)(nil), "DoslinkMessageSignature")
