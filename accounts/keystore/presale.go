...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/doslink/pydossaletool

		pydossaletool generates the encryption key from password by
	...
	*/
	...
	dosPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(dosPriv)
	...
	expectedAddr := preSaleKeyStruct.DosAddr
