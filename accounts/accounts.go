...
// Package accounts implements high level Doslink account management.
package accounts
...
// Account represents an Doslink account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Doslink account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain doslink.ChainStateReader)
