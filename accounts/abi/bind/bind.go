...
// Package bind generates Doslink contract Go bindings.
//
// Detailed usage document and tutorial available on the dos Wiki page:
// https://github.com/doslink/dos/wiki/Native-DApps:-Go-bindings-to-Doslink-contracts
package bind
