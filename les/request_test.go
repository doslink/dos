...
type accessTestFn func(db dosdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db dosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db dosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db dosdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db dosdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
