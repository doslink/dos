...
func newTestLDB() (*dosdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "dosdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := dosdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(dosdb.NewMemDatabase(), t)
}

func testPutGet(db dosdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(dosdb.NewMemDatabase(), t)
}

func testParallelPutGet(db dosdb.Database, t *testing.T) {
	const n = 8
