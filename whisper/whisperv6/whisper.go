...
// Whisper represents a dark communication interface through the Doslink
...
// New creates a Whisper client ready to communicate through the Doslink P2P network.
