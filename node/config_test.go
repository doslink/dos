...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdos.ipc", false, filepath.Join(os.TempDir(), "gdos.ipc")},
		{"data", "gdos.ipc", false, "data/gdos.ipc"},
		{"data", "./gdos.ipc", false, "./gdos.ipc"},
		{"data", "/gdos.ipc", false, "/gdos.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdos.ipc", true, `\\.\pipe\gdos.ipc`},
		{"data", "gdos.ipc", true, `\\.\pipe\gdos.ipc`},
		{"data", `\\.\pipe\gdos.ipc`, true, `\\.\pipe\gdos.ipc`},
	}
