...
import (
	...
	"github.com/doslink/dos/contracts/chequebook"
	"github.com/doslink/dos/contracts/ens"
	...
	httpapi "github.com/doslink/dos/swarm/api/http"
	"github.com/doslink/dos/swarm/fuse"
	"github.com/doslink/dos/swarm/network"
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := dosclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := dosclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
