...
// Package chequebook package wraps the 'chequebook' Doslink smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in doser; (auto)cashing cheques in doser
// as well as (auto)depositing doser to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/doslink/dos/contracts/chequebook/contract"
	"github.com/doslink/dos/core/types"
	"github.com/doslink/dos/crypto"
	"github.com/doslink/dos/log"
	"github.com/doslink/dos/swarm/services/swap/swap"
)
...
// * depositing doser to the chequebook
// * watching incoming doser
...
// Cash cashes the cheque by sending an Doslink transaction.
