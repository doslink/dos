...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllDosashProtocolChanges, new: AllDosashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllDosashProtocolChanges, new: AllDosashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllDosashProtocolChanges,
