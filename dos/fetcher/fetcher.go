...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (dos/61) or header (dos/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (dos/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both dos/61 and dos/62)
}
