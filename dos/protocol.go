...
var ProtocolName = "dos"

// ProtocolVersions are the upported versions of the dos protocol (first is primary).
var ProtocolVersions = []uint{dos63, dos62}
...
// dos protocol message codes
const (
	// Protocol messages belonging to dos/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to dos/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
