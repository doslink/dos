...
// PeerInfo represents a short summary of the Doslink sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Doslink protocol version negotiated
...
// Handshake executes the dos protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("dos/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Doslink sub-protocol.
type peerSet struct {
