...
// Syncing provides information when this nodes starts synchronising with the Doslink network and when it's finished.
...
type SyncingResult struct {
	...
	Status  doslink.SyncProgress `json:"status"`
}
