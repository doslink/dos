...
# 1. install gdos for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdos
# 5. create gdos, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable DOSLINK_SOCKET
...
!define GROUPNAME "Doslink"
!define APPNAME "Gdos"
!define DESCRIPTION "Official Go implementation of the Doslink protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gdos is installed global
