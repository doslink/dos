Name "gdos ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/doslink/dos/issues"
!define UPDATEURL "https://github.com/doslink/dos/releases"
!define ABOUTURL "https://github.com/doslink/dos#doslink-go"
...
# Install gdos binary
Section "Gdos" GDOS_IDX
  SetOutPath $INSTDIR
  file {{.Gdos}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdos.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdos.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gdos incoming peers (TCP:30605)"
  SimpleFC::AdvRemoveRule "Gdos outgoing peers (TCP:30605)"
  SimpleFC::AdvRemoveRule "Gdos UDP discovery (UDP:30605)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gdos incoming peers (TCP:30605)" ""  6 1 1 2147483647 1 "$INSTDIR\gdos.exe" "" "" "Doslink" 30605 "" "" ""
  SimpleFC::AdvAddRule "Gdos outgoing peers (TCP:30605)" ""  6 2 1 2147483647 1 "$INSTDIR\gdos.exe" "" "" "Doslink" "" 30605 "" ""
  SimpleFC::AdvAddRule "Gdos UDP discovery (UDP:30605)" "" 17 2 1 2147483647 1 "$INSTDIR\gdos.exe" "" "" "Doslink" "" 30605 "" ""

  # Set default IPC endpoint (https://github.com/doslink/EIPs/issues/147)
  ${EnvVarUpdate} $0 "DOSLINK_SOCKET" "R" "HKLM" "\\.\pipe\gdos.ipc"
  ${EnvVarUpdate} $0 "DOSLINK_SOCKET" "A" "HKLM" "\\.\pipe\gdos.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GDOS_IDX}
    SectionGetSize ${GDOS_IDX} $0
