...
type Database struct {
	diskdb dosdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb dosdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch dosdb.Batch) error {
	// If the node does not exist, it's a previously committed node
